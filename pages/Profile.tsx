    ...
    <div className="bg-slate-950 min-h-screen">
      ...
      <div className="px-4 -mt-20 max-w-md mx-auto relative z-10 pb-6">
            ...
            <div className="p-6 bg-orange-500/10">
              ...
              <div className="space-y-3">
                {friendRequests.map((reqUser) => (
                  <div
                    key={reqUser.uid}
                    className="flex items-center justify-between bg-slate-900 p-3 rounded-2xl shadow-sm border border-slate-800"
                  >
                    <div
        ...
        <div className="mt-8 mb-4">
          <h2 className="text-xl font-bold text-white px-2 mb-4">
