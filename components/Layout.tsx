...
const Layout: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-slate-950">
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 inset-x-0 bg-slate-900/80 backdrop-blur-xl border-t border-slate-800 pb-[max(env(safe-area-inset-bottom),env(safe-area-inset-bottom))] z-[2000]">
